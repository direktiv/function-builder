...
func (o *PostBody) validateAddress(formats strfmt.Registry) error {
...
func (o *PostBody) validateSearch(formats strfmt.Registry) error {

	if err := validate.Required("body"+"."+"search", "body", o.Search); err != nil {
		return err
	}
