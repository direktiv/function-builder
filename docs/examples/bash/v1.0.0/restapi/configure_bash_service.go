...
import (
	...
	"bash-service/restapi/operations"
)

//go:generate swagger generate server --target ../../v1.0.0 --name BashService --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.BashServiceAPI) {
...
func configureAPI(api *operations.BashServiceAPI) http.Handler {
