...
//go:generate swagger generate server --target ../../app --name Bash --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv/service-builder/docs/examples/bash/bash/build/templates --principal interface{}

func configureFlags(api *operations.BashAPI) {
...
func configureAPI(api *operations.BashAPI) http.Handler {
